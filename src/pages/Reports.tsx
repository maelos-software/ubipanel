...
export function Reports() {
  ...
  const colorClasses: Record<string, { bg: string; icon: string; border: string }> = {
    ...
    red: { bg: "bg-red-500/10 dark:bg-red-500/20", icon: "text-red-600", border: "border-red-200" },
  ...
  const renderReportCard = (report: ReportCard) => {
    ...
    return (
      <button
        ...
        className="text-left p-5 bg-[var(--bg-secondary)] rounded-2xl shadow-sm ring-1 ring-[var(--border-primary)] hover:shadow-md hover:ring-gray-200 transition-all group"
      >
